...
function prepLogin($id, $email,$usertype)
{
    $_SESSION['m_id'] = $id;
    ...
    $_SESSION["successMessage"] =  "Welcome Merchant";
...
function uploadProduct($product_name,$shop_hidden_id) {
    ...
    if($_FILES['image']['tmp_name']) {
        ...
        $filename1 = $shop_hidden_id.$product_name."product1".".{$ext1}";
