        ...
        <div class="container" style="margin-bottom: 100px;">
            ...
            <div class="card login-card">
                <div class="card-body">
                    ...
                    <h4 class="card-title text-canter mb-4">Update Account</h4>
                    ...
                    <form class="" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-12">
                                ...
                                <input type="text" name="City" size="32" value="<?php if (isset($city)) echo $city; ?>" maxlength="100" class="form-control" placeholder="City" />
                            </div> <!-- form-group end.// -->
                        </div> <!-- form-row.// -->
