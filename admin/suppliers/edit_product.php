...
include('functions/classes/edit_product.class.php');
?>
    ...
    <div class="col-md-12">
        ...
        <div class="card login-card mx-auto" style="max-width:450px;">
            <div class="card-header card-header-primary">
                ...
                <p class="card-category">Edit Supplier Products</p>
            </div>
            <div class="card-body">
                <div class="col-md-12">
...
<div class="row">
  <div class="col-md-12">
    ...
    <select name="Category" class="form-control">
        ...
        <small class="text-primary">Please add categories before adding products</small>
    </div>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <textarea class="form-control" name="Description" cols="5" rows="10"><?php if (isset($product_description)) echo $product_description; ?></textarea>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-md-12">
    <div class="form-group bmd-form-group">
    <label>Price</label>
    <input type="text" name="Price" size="5" placeholder="R" maxlength="10" value="<?php if (isset($product_price)) echo $product_price; ?>" class="form-control" />
    </div>
  </div>
</div>


<button type="submit" name="editproduct" class="btn btn-primary pull-right">Add Product</button>
<a class="btn btn-danger pull-left" href="supplier.php?single=<?php if (isset($_GET['edit_product'])) echo $_GET['edit_product']; ?>">
